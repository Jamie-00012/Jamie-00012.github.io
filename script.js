...
if (studioLab) {
  ...
  const materials = {
    woven: { image: 'assets/mate-x6-sunset-product.webp', alt: '日落渐变中的芳纶纤维手机壳视觉实验', caption: 'Woven light / quiet warmth', note: 'Kevlar fiber · sunset gradient', index: '01' },
    ...
    soft: { image: 'assets/concept-scene.webp', alt: '亲肤材质与柔和光线的产品视觉实验', caption: 'Soft touch / measured calm', note: 'Soft-touch surface · tactile light', index: '03' }
  };
